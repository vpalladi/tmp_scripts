...
for i,x in enumerate(X) :
    for q in range(10,18) :
        ...
        x.getNode ( "datapath.region.mgt.rw_regs.ch0.control.loopback" ).write(4) 
        x.getNode ( "datapath.region.mgt.rw_regs.ch1.control.loopback" ).write(4) 
        x.getNode ( "datapath.region.mgt.rw_regs.ch2.control.loopback" ).write(4) 
        x.getNode ( "datapath.region.mgt.rw_regs.ch3.control.loopback" ).write(4) 
        x.dispatch()
