...
for d in dev :
        ...
        for q in range(10,18):
                ...
                for i in range(0,4) :
                        ...
                        d.getNode ( "datapath.region.mgt.rw_regs.ch"+str(i)+".control.reset_crc_counters" ).write(1)
                        d.dispatch();
                        d.getNode ( "datapath.region.mgt.rw_regs.ch"+str(i)+".control.reset_crc_counters" ).write(0)
                        d.dispatch();
                        d.getNode ( "datapath.region.mgt.rw_regs.ch"+str(i)+".control.reset_crc_counters" ).write(1)
                        d.dispatch();
                        d.getNode ( "datapath.region.mgt.rw_regs.ch"+str(i)+".control.reset_crc_counters" ).write(0)
                        ...
                        print("Reset Error Coutner of Cnannel ", str(i), q )
                time.sleep(0.1)
